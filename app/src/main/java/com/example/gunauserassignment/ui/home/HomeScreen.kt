...
import com.example.gunauserassignment.R
import com.example.gunauserassignment.data.DataProvider
import com.example.gunauserassignment.data.User
import com.example.gunauserassignment.navigation.ROUTE_HOME
import com.example.gunauserassignment.navigation.ROUTE_LOGIN
import com.example.gunauserassignment.ui.auth.AuthViewModel
import com.example.gunauserassignment.ui.theme.AppTheme
import com.example.gunauserassignment.ui.theme.spacing
...
//@Composable
//fun showUserData(viewModel: AuthViewModel?) {
////    val users = viewModel?.listOfUsersFlow?.collectAsState()
//
//    LazyColumn(
//        contentPadding = PaddingValues(horizontal = 16.dp, vertical = 8.dp)
//    ) {
